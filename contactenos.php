        ...
        <div class="container mtb">
            <div class="row">
                <div class="col-lg-6">
                    <h4>Bienvenido!</h4>
                    <div class="hline"></div>
                    <p>Cuéntenos sobre qué tema o servicio necesita asesoría y uno de nuestros asesores se pondrá en contacto con usted. </p>
                    <form role="form">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hline"></div>
                    <p>
                        Calle 26 Sur No. 93 D - 38<br/>Bogotá, Colombia.<br/>
                    </p>
                    <p>
                        Email: ehidraulicos.jr@hotmail.com<br/>
                        Cels: 310 345 6426 - 314 440 7899 - 314 457 8345 <br/>
                        Tels: 704 7550 - 445 0442 
                    </p>
