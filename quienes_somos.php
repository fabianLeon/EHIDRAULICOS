    ...
    <body>
        ...
        <div class="container mtb">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h3>MISION.</h3>
                    <p>EQUIPOS HIDRÁULICOS SAS es una empresa dedicada principalmente a la prestación de servicios a equipos de bombeo como instalación, reparación, mantenimiento, lavado y desinfección de tanques de reserva, limpieza de posos de aguas lluvias y negras entre otros, dirigidos a entidades públicas y privadas, contamos con personal capacitado y entrenado, conformes con el futuro de la empresa.</p>
                    <br><h3>VISION.</h3>
                    <p>Ser una empresa con el más alto nivel de servicio al cliente, centrados en la confianza y credibilidad de nuestro trabajo para los Clientes.</p>
                    <p><br/><a href="contactenos.php" class="btn btn-theme">Contáctenos</a></p>
                </div>
            </div><! --/row -->
        </div><! --/container -->
